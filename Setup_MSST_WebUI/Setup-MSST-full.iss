...
OutputDir=E:\vs\SetupTools
OutputBaseFilename=Setup_MSST_WebUI_{#MyAppVersion}_Full
Compression=lzma
...
[Files]
Source: "E:\vs\MSST-WebUI-InnoSetup\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\vs\MSST-WebUI-InnoSetup\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
